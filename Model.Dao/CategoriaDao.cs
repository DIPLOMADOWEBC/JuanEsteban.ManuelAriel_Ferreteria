...
using Model.Dao.EntityContext;

namespace Model.Dao
{
    public class CategoriaDao:Obligatorio<Categoria>
    {
        //JEGM 06ABR2019 : Conexion EntityFramework
        ...
        public void create(Categoria objCategoria)
        {
            ...
            try
            {
                ...
                cat.idCategoria = objCategoria.IdCategoria;
                cat.nombre = objCategoria.Nombre;
                cat.descripcion = objCategoria.Descripcion;
